...
public class AddProductControl extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String salep = request.getParameter("sale");
        ...
        String descriptionp = request.getParameter("descriptions");
        String categoryp = request.getParameter("category");
        ProductDAO da = new ProductDAO();
        da.insertProduct(pricep, salep, name, quantityp, brandP, img, descriptionp, categoryp);
