<%-- 
    Document   : contact
    Created on : Jan 31, 2024, 7:43:32 AM
    Author     : HP
--%>
...
<html lang="zxx" class="no-js">
    ...
    <body>
        ...
        <section class="contact_area section_gap_bottom">
            <div class="container">
                <div id="mapBox" class="mapBox" data-lat="21.012421688341508" data-lon="105.5227142742388" data-zoom="13" data-info="Trường Đại học FPT
                     Khu Công Nghệ Cao Hòa Lạc, km 29, Đại lộ, Thăng Long, Hà Nội."
                     data-mlat="21.012421688341508" data-mlon="105.5227142742388">
                </div>
                <div class="row">
                    <div class="col-lg-3">
                        <div class="contact_info">
                            <div class="info_item">
                                ...
                                <h6>Thach That, Ha Noi.</h6>
                                <p>Thôn 3, Thạch Hòa </p>
                            </div>
                            <div class="info_item">
                                <i class="lnr lnr-phone-handset"></i>
                                <h6><a href="#">+84 395200926</a></h6>
                                <p>Mon to Fri 9am to 6 pm</p>
                            </div>
                            <div class="info_item">
                                <i class="lnr lnr-envelope"></i>
                                <h6><a href="#">dinhvietchung34@gmail.com</a></h6>
