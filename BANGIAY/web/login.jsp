...
<html lang="zxx" class="no-js">
    ...
    <body>
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="nav-item"><a href="cart.jsp" class="cart"><img src="img/avatar/cart.png" style="height: 30px;margin-top: 20px">  </a></li>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="login_box_img">
                            ...
                            <div class="hover">
                                <h4>WELCOME TO OUR ONLINE SHOPPING</h4>
                                <p>Chúc bạn có trải nghiệm mua sắm tuyệt vời nhất tại đây  </br>
                                ...
                                <!-- <form action="signup" method="post" class="form-signup">
                                    ...
                                    <button class="btn btn-primary btn-block" id="btn-signup" type="submit"><i class="fas fa-user-plus" ></i> Sign Up</button>
                    ...
                    <div class="col-lg-6">
                        <div class="login_form_inner">
                            ...
                            <form class="row login_form" action="login" method="post" id="contactForm" novalidate="novalidate">
                                ...
                                <div class="col-md-12 form-group" id="passLogin">
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <button class="primary-btn" ><a   href="signUp.jsp">SIGN-UP</a></button>
        ...
        <script>
            let icon = document.querySelector('#passLogin i');
            let pass = document.querySelector('#passLogin input');
            let check=false;
            console.log(icon);
            console.log(pass);
