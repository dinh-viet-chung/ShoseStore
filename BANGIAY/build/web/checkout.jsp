<%-- 
    Document   : checkout
    Created on : Jan 31, 2024, 7:40:51 AM
    Author     : HP
--%>
                ...
                <div class="container">
                    ...
                    <div class="billing_details">
                        <div class="row">
                            ...
                            <form class="row contact_form" action="check" method="post">
                                <div class="col-md-6 form-group p_star">
                                    <input type="date" class="form-control" id="email" value="${sessionScope.lo.dob}" name="date">

                                </div>
                                <div class="col-md-6 form-group p_star">
                                    <input type="text" class="form-control" id="number" value="${sessionScope.lo.phone}" name="phone">

                                </div>
                                <div class="col-md-12 form-group p_star">
                                    <input type="text" class="form-control" id="add1" name="add" placeholder="Enter your Address">

                                </div>  
                                <div class="col-md-12 form-group p_star">
                                    <input type="text" class="form-control"  id="add1" name="email" placeholder="Enter your Email">

                                </div>  
                                <div class="col-md-6 form-group p_star">
                                    <input type="text" class="form-control" id="first" value="${sessionScope.lo.fullName}" name="fname">
                                    <input type="hidden" value="${sessionScope.lo.id}" name="idUser">
                                </div>
                                <div class="col-md-6 form-group p_star">
                                    <input type="text" class="form-control" id="last" value="${sessionScope.lo.userName}"  name="name" readonly>

                                </div>
                                <label for="cars">Chọn phương thức thanh toán:</label>
                                <select name="sell" id="cars">
                                    <option value="Thanh toán khi nhận hàng" >Thanh toán khi nhận hàng </option>
                                    <option value="Thánh toán qua ZALO PAY">Thanh toán qua ZALO PAY</option>
                                    <option value="Thanh toán qua thẻ" >Thanh toán qua thẻ</option>
                                </select> 



                                <div   style="margin-top: 0px; padding-right: 700px;">
