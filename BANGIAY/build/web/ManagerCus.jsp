        ...
        <div class="container">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <a href="home"> <h2>Manager<b>Customers</b></h2></a>                          
                        </div>
                        <div class="col-sm-6">
                    ...
                    <tbody>
                        <c:forEach items="${listP}" var="o">
                            <tr>
                                ...
                                <td>
                                    <a href="loadC?id=${o.id}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>

                                </td>
                        <div>${requestScope.ok}</div>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
